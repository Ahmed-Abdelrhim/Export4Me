...
value="{{old('landline')}}"/>--}}
            <input name="landline" type="text" placeholder="02xxxxxxxx" class="box form-control @error('landline') is-invalid @enderror" value="{{old('landline')}}"/>
            @error('landline')
            <span class="text-danger">{{$message}}</span>
            @enderror
...
id="phone_number" value="{{old('phone_number')}}"/>--}}
            <input name="phone_number" type="text" placeholder="01xxxxxxxxx" class="box form-control @error('phone_number') is-invalid @enderror" id="phone_number"
