...
@section('content')
    ...
    <div class="row">
        <form action="{{route('exporter.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <input name="owner_name" type="text" placeholder="ادخل اسم المنشأء " class="box form-control"
            ...
            <input name="factory_address" type="text" placeholder="ادخل عنوان المصنع " class="box form-control @error('factory_address') is-invalid @enderror"
            ...
            <input name="country" type="text" placeholder=" ما هي دولتك " class="box form-control @error('country') is-invalid @enderror"
                   id="country" required value="{{old('country')}}" />
            @error('country')
            <span class="text-danger">{{$message}}</span>
            @enderror
            ...
            <input name="email" type="email" placeholder="ادخل الأيميل" class="box" id="email form-control @error('email') is-invalid @enderror"
...
{{--            <input name="landline" type="number" placeholder="ادخل رقم التليفون الأرضي" class="box"  id="landline" />--}}
            <input name="landline" type="number" placeholder="02xxxxxxxx" class="box form-control @error('landline') is-invalid @enderror"
                   id="landline" required value="{{old('landline')}}" />
            @error('landline')
            <span class="text-danger">{{$message}}</span>
            @enderror
...
{{--            <input name="phone_number" type="number" placeholder="ادخل رقم الهاتف المحمول" class="box" id="phone_number" />--}}
            <input name="phone_number" type="number" placeholder="01xxxxxxxxx" class="box form-control @error('phone_number') is-invalid @enderror"
            ...
            <input name="product_name" type="text" placeholder="ادخل اسم المنتج " class="box form-control @error('product_name') is-invalid @enderror"
                   id="product_name" required value="{{old('product_name')}}" />
            @error('product_name')
            <span class="text-danger">{{$message}}</span>
            @enderror
            ...
            <input name="product_description" type="text" placeholder="ملاحظات " class="box form-control @error('product_description') is-invalid @enderror"
                   id="product_description"  value="{{old('product_description')}}" />
            ...
            <input name="production_quantity" type="text" placeholder="كميه الإنتاج " class="box form-control @error('production_quantity') is-invalid @enderror"
                   id="production_quantity" value="{{old('production_quantity')}}" />
            ...
            <input name="local_selling" type="text" placeholder="اين تبيع" class="box form-control @error('local_selling') is-invalid @enderror"
                   id="local_selling" value="{{old('local_selling')}}" />
            @error('local_selling')
            <span class="text-danger">{{$message}}</span>
            @enderror
            ...
            <input name="country_export_to_before" type="text" placeholder="ادخل  بلد صدرت لها "
                   class="box form-control @error('country_export_to_before') is-invalid @enderror"
                   id="country_export_to_before" value="{{old('country_export_to_before')}}"/>
            ...
            <input name="country_export_to_before_value" type="text" placeholder="ادخل القيمه "
                   class="box form-control @error('country_export_to_before_value') is-invalid @enderror"
                   id="country_export_to_before_value"
            ...
            <input name="exporter_place" type="text" placeholder="ادخل البلد " class="box  form-control @error('exporter_place') is-invalid @enderror"
                   id="exporter_place" required value="{{old('exporter_place')}}" />
            ...
            <textarea name="shipping_worked_before" placeholder="ادخل شركه شحن " class="box form-control @error('shipping_worked_before') is-invalid @enderror"
                      id="shipping_worked_before"></textarea>
            ...
            <select name="exporter_record" id="exporter_record" class="form-control @error('exporter_record') is-invalid @enderror">
            ...
            <select name="export_paper" id="export_paper" class="form-control @error('export_paper') is-invalid @enderror">
                <option value="1">نعم</option>
                <option value="2"> لا</option>
            </select>
            @error('export_paper')
            ...
            <select name="photo_team" id="photo_team" class="form-control @error('photo_team') is-invalid @enderror">
                <option value="1">نعم</option>
                <option value="2"> لا</option>
            </select>
            @error('photo_team')
            ...
            <input type="file" class="commercial_record form-control @error('commercial_record') is-invalid @enderror " name="commercial_record"
                   accept="image/png, image/jpeg, image/jpeg, image/webp" id="commercial_record" />
            ...
            <input type="file" class="product_brochure form-control @error('product_brochure') is-invalid @enderror" name="product_brochure"
                   accept="image/png, image/jpeg, image/jpeg, image/webp" id="product_brochure" />
