<div id="dw-s1" class="bmd-layout-drawer bg-faded" aria-expanded="true" aria-hidden="true">
    ...
    <div class="container-fluid side-bar-container">
     ...
     <ul class="side a-collapse short">
            ...
            <div class="side-item-container ">
                <li class="side-item">
                    <a href="{{route('admin.vistor.index', 'Allvistorsmanager')}}" class="side-item "><i class="fas fa-fan fa-spin mr-1"></i>زيارات المشرفين</a>
                </li>
                <li class="side-item">
                    <a href="{{route('admin.vistor.index', 'Allvistors')}}" class="side-item "><i class="fas fa-fan fa-spin mr-1"></i>زيارات المطورين</a>
                </li>
            </div>
        </ul>
