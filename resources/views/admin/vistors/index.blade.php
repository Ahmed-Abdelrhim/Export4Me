    ...
    <main class="bmd-layout-content">
        <div class="container-fluid">
            ...
            <div class="jumbotron shade pt-5">
                    <div class="action">
                        @if ($page == 'Allvistors')
                            <a href="{{ route('admin.vistor.export', 'All') }}" class="btn btn-main f-forth fnt-xxs">تصدير كملف اكسل</a>
                        @else 
                            <a href="{{ route('admin.vistor.export', 'manager') }}" class="btn btn-main f-forth fnt-xxs">تصدير كملف اكسل</a>
                        @endif
                        <form method="POST" action="{{route('admin.vistors.destoryAll')}}" style="display: inline-block">
                            @csrf
